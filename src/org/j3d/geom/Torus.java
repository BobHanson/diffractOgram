...
//        int[] lala = new int [data.stripCounts.length-1];
//        float[] lala2 = new float [data.coordinates.length-30];
//        for (int iii=0; iii<lala.length; iii++) lala[iii]=data.stripCounts[iii];        
//        for (int iii=0; iii<lala2.length; iii++) lala2[iii]=data.coordinates[iii];        
        
        TriangleStripArray geometry =
//            new TriangleStripArray(data.vertexCount-10, format, lala);
        new TriangleStripArray(data.vertexCount, format, data.stripCounts);

//System.out.println("data.vertexCount : "+data.vertexCount);
//System.out.println("data.stripCounts : ("+data.stripCounts.length+")");
//for (int iii=0; iii<data.stripCounts.length; iii++) System.out.println(data.stripCounts[iii]); 

//System.out.println("data.coordinates : ("+data.coordinates.length+")");
//for (int iii=0; iii<data.coordinates.length; iii++) System.out.println(data.coordinates[iii]); 

//for (int iii=0; iii<data.coordinates.length; iii++) 
//	if ((iii/3)%4==3)
//		data.coordinates[iii] = data.coordinates[iii-3];
