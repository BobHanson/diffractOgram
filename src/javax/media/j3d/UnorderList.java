...
public class UnorderList implements Cloneable, java.io.Serializable  {
     ...
     */
     public UnorderList(int initialCapacity, Class componentType) {
     ...
     */
    public synchronized final Object[] toArray(boolean copy) {
	if (copy) {
	    if (isDirty) {
     ...
     */
     public synchronized final void add(Object o) {
	if (elementData.length == size) {
	    Object oldData[] = elementData;
	    elementData = (Object[])java.lang.reflect.Array.newInstance(
						 componentType,
