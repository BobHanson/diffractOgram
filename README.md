...
Also in DiffractOgram2 the goniometer is not shown. Instead, normalized crystal a, b, and c axes are indicated on a wave-length-independent unit sphere. Making the Ewald sphere a unitless unit sphere allows us to visualize the allowed reflections as points along a unitless number line that is laid out along each of the three crystal axes, where the indexes are h, k, and l:
